...
class BlogcommentsController extends BackendController {
    ...
    private function getSearchForm() {
        ...
        $fld1 = $frm->addButton('', 'btn_cancel', 'Clear Search', '', 'style="margin-left:10px; cursor:pointer;"  onclick=location.href="' . Utilities::generateUrl("blogcomments") . '"');
    ...
    function listComments($data=array()) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_submit'])) {
            ...
            $pagesize = Settings::getSetting("CONF_DEFAULT_ADMIN_PAGING_SIZE");
