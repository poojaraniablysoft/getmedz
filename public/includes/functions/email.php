...
function sendMailTpl($to, $tpl, $vars=array(), $extra_headers='',$smtp=0,$smtp_arr=array()) {
	...
	$company_logo="<img src='".generateAbsoluteUrl('image', 'site_email_logo',array(Settings::getSetting("CONF_EMAIL_LOGO")),CONF_WEBROOT_URL)."' alt=''  />";
	...
	if (Settings::getSetting("CONF_SEND_EMAIL")){
		if ((Settings::getSetting("CONF_SEND_SMTP_EMAIL")) || $smtp){
			return sendSmtpEmail($to, $subject, $body,'',$smtp_arr);
		}
		else
