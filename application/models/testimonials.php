...
class Testimonials  extends Model {
	...
	public static function searchTestimonials() {
        $srch = new SearchBaseNew('tbl_testimonials', "tes");
        return $srch;
    }
    ...
    static function  search($criteria) {
		$srch = new SearchBaseNew('tbl_testimonials', 'tm');
	...
	function addUpdate($data){
		...
		$assign_fields['testimonial_status'] = $data['testimonial_status'];
