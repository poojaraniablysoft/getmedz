...
class Navigation extends Model{
	...
	function getNavigation($nav_id,$pagesize=0){		
		 $log_protection=Members::isUserLogged()?1:2;
		 ...
		 $nav->joinTable('tbl_cms_contents', 'INNER JOIN', 'nl.nl_cms_page_id= cm.cmsc_id AND nl.nl_is_deleted=0', 'cm');
		 $nav->addCondition('nl.nl_is_deleted','=',0);
		 $nav->addCondition('nl.nl_login_protected','in',array("0","2",$log_protection));
