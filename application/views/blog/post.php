        ...
        <div class="content">
            ...
            <?php if ($post_data || is_array($post_data)) { ?>
                    ...
                    <div class="post">
                        <div class="top">
                            <div class="date">
                                <p><?php echo dateFormat("d", $post_data['post_published']); ?></p> <span class="month"><?php echo dateFormat("M", $post_data['post_published']); ?></span> </div>
                            <div class="cmnt_area">

                                <h2 class="title"><?php echo ucfirst($post_data['post_title']); ?></h2>
                                <div class="post-meta">
                                    <ul class="cmt-box">
                                        <li> <i class="icon ion-eye"></i><?php echo getLabel('L_Views');?> [<?php echo $post_data['post_view_count']; ?>]</li>
                                        <?php if ($post_data['post_comment_status'] != 0) { ?>
                                            <li><i class="icon ion-chatbubble-working"></i><?php echo getLabel('L_Comments');?> [<?php echo $comment_count; ?>] </li>
                                        <?php } ?>
                                        <?php if (!empty($post_data['post_contributor_name']) && $post_data['post_contributor_name'] != '') { ?>
                                            <li><i class="icon ion-person"></i><?php echo getLabel('L_Author');?> [<?php echo $post_data['post_contributor_name']; ?>]</li>
                                        <?php } ?>
                                    </ul>
                                </div>
                        ...
                        <div class="post_imges">
                            ...
                            if (!empty($slider_images) && count($slider_images) > 1) {
                                ...
                                <div  class="areagallery">
                                    ...
                                    <ul class="slider_nav" >
                                        ...
                                        foreach ($slider_images as $slide_images1) {
                                            echo '<li><img src="' . generateUrl('image', 'post', array('thumb', $slide_images1['slide_images'])) . '"></li>';
                                        }
                                        ?>
                                    </ul>
                                </div>
                                ...
                                if (!empty($slider_images[0]['slide_images'])) {
                                    echo '<div class="cell-img img-responsive"><img src="' . generateUrl('image', 'post', array('large', $slider_images[0]['slide_images'])) . '"></div>';
                                }
                            }
                            ?>
                        </div>
                        ...
                        <div class="sharewrap">
                            ...
                            <div class="addthis_toolbox addthis_default_style" addthis:title="<?php echo $post_data['post_title']; ?>" addthis:url="<?php echo generateAbsoluteUrl('blog', 'post', array($post_data['post_seo_name'])); ?>" >
                    ...
                    if ($post_data['post_comment_status'] != 0) {
                        ...
                        <div class="add-comnt" id="comment-form">
                            <div class="add-review">
                                <h2><?php echo getLabel('L_Add_Your_Comment');?> </h2>
                                ...
                                <table class="reviewTbl">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $frmComment->getFieldHtml('htmlNote'); ?></td>
                ...
                <div class="no_result">
                    ...
                    <div class="no_result_text">                        
                        ...
                        <p><?php echo getLabel('L_Try_To_Search_With_Different_Keyword');?> <br>
                            <a class="btn" href="<?php echo generateUrl('blog'); ?>">
                        <?php echo getLabel('L_Back_To_Blog');?></a> </p>
                    </div>
                </div>
            </div>
        <?php } ?>
