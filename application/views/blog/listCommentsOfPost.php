...
if ($records || is_array($records)) {
    ...
    <div class="comment-section">
        <h2><?php echo getLabel('L_Comments:');?> </h2>
        <?php
        ...
        foreach ($records as $records1) {	 
            ...
            <div class="comnt">
                ...
                <?php 
                  ...
                  echo '<img width="34" src="'.generateUrl('image', 'user', array($records1['user_profile_image'], 'thumb')).'" alt="">';
                  }else{
                  echo '<img width="34"  src="'.generateUrl('image', 'user', array('','thumb')).'" alt="">';
                  } 
                ?>
                 </div>
    ...
    if ($pages > 1) {
        ...
        echo renderView('common/blog-pagination.php', $vars);
    }
}
?>
