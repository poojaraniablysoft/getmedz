...
if (count($arr_listing) > 0) {
  foreach ($arr_listing as $question) { ?> 
	...
	S9.311,3.077,17,3.077C24.686,3.086,30.913,9.314,30.923,17C30.923,24.689,24.689,30.923,17,30.923z"/>
			...
			</i><span><?php echo getLabel('L_You_have_');?><?php echo $question['count_replies'].' '.getLabel('L_New_Answer') ?></span></li>
 ...
 <?php
  ...
  <h2>'. getLabel('L_You_Do_not_have_any_follow_up_questions').'</h2>
</div></div>';
	}
	?>
