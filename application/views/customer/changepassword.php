            ...
            <div class="dashboard">
              ...
              <div class="dashboard__content">
                ...
                <div class="profileNav">
				  <ul>
					<li><a  href="<?php echo generateUrl('customer','profile') ?>"><?php echo getLabel('L_Edit_profile');?></a></li>
					<li><a class="active" href="<?php echo generateUrl('customer','changepassword') ?>"><?php echo getLabel('L_Change_Password');?></a></li>
				  </ul>
				</div>
