              ...
              <div class="dashboard__content">
                ...
                <div class="dashboard_bordered-box">
					...
					<table class="table table-responsive " id="response_table">
                            ...
                            <tr><td class="question"><span class="table-title">Question</span>
								<h3><?php echo $question['orquestion_question'] ?></h3>
								<span class="questio_askedon"><span>Asked On</span> <?php echo $question['order_date'] ?> </span>
                            ...
                            <tr>
							**Please note that the information just provided cannot replace you going to a physician or competent provider and that you should consider seeking local attention at your own discretion.
							</tr>
                        </tbody></table>
					</div>
					</div>
					<div id="question_reply" class="replies-js"></div>
					<?php  if ($question['orquestion_status'] == Question::QUESTION_CLOSED ){?>
								<div class="note question-close"> Question CLOSED</div>
