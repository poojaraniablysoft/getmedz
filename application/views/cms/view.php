...
<?php if ($hide_header_footer) {
	...
	echo  '<script type="text/javascript" language="javascript" src="' . generateUrl('pagejsandcss', 'js', array($pathinfo['dirname'],'cms/view'), $use_root_url, false) . '&sid=' . time() . '"></script>' . "\n";
 }?>
<div>
